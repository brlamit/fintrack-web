...
<div class="relative z-10 w-full max-w-md mx-auto px-4">
    ...
    <header class="mb-8 flex flex-col items-center text-center">
        <div class="mb-4 transform -rotate-3 hover:rotate-0 transition-transform duration-300">
            <img src="{{ asset('images/logo.png') }}" alt="FinTrack Logo" class="w-16 h-16 rounded-2xl shadow-xl border-4 border-white" onerror="this.src='https://ui-avatars.com/api/?name=FT&background=14b8a6&color=fff'">
        </div>
